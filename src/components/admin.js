        ...
        <div className="text-white bg-dark rounded-2xl shadow w-full p-4">
          <form className="flex flex-col items-center md:flex-row md:justify-evenly">
            ...
            <label className="flex gap-2">
              <span className="bg-green-blue text-white py-2 px-4 rounded-lg cursor-pointer hover:bg-opacity-90 active:transform active:-translate-y-1/4 scale-85  transition ease-in-out hover:-translate-y-0.5 hover:scale-105 duration-150">
            ...
            <div className="flex gap-2 m-2 md:m-0">
              ...
              <button
                onClick={resetForm}
                className="bg-err-red py-2 px-3 rounded-lg hover:bg-opacity-90  active:transform active:-translate-y-1/4 scale-110 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-150"
              >
